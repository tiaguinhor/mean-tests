            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav  ml-auto">
                    <li class="nav-item active">
                        <router-link tag="a" :to="{name: 'home'}" class="nav-link">All</router-link>
                    </li>

                    <li class="nav-item" v-for="category in categories" :key="category._id">
                        <router-link tag="a" :to="{name: 'category', params: {category: category._id}}" class="nav-link">{{ category.title }}</router-link>
                    </li>
